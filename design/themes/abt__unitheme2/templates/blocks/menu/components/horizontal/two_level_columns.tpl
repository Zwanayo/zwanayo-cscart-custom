...
{foreach from=$splited_elements item="row"}
    ...
    <div class="ty-menu__submenu-col" {if $settings.abt__device !== "mobile"}style="{if $item1.abt__ut2_mwi__dropdown == "YesNo::NO"|enum}width:{$col_width}%;{else}min-height: var(--ut2-horizontal-menu-block-height);{/if}"{/if}>
