...
{if !$item1.$childs|fn_check_second_level_child_array:$childs}
    {hook name="blocks:topmenu_dropdown_2levels_elements"}
        ...
        <div class="ty-menu__submenu-items cm-responsive-menu-submenu ut2-simple {if $item1.abt__ut2_mwi__text && $item1.abt__ut2_mwi__text_position !== "bottom" && $item1.abt__ut2_mwi__dropdown === "YesNo::NO"|enum}with-pic {/if}" {if $settings.abt__device === "desktop"}style="min-height: var(--ut2-vertical-menu-block-height)"{/if}>
            <div {if $settings.abt__device === "desktop"}style="min-height: var(--ut2-vertical-menu-block-height)"{/if}>
            ...
            {if $item1.abt__ut2_mwi__status === "YesNo::YES"|enum && $item1.abt__ut2_mwi__dropdown === "YesNo::NO"|enum && $item1.abt__ut2_mwi__text_position === "bottom" && $item1.abt__ut2_mwi__text|trim && $settings.abt__device !== "mobile"}
