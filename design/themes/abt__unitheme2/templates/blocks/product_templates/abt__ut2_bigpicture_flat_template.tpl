...
{if $settings.abt__device != "mobile"}
    ...
    <div class="ut2-pb ty-product-block ty-product-detail ut2-big-image ut2-big-image-flat {if $settings.abt__ut2.products[$settings.abt__details_layout].multiple_product_images[$settings.abt__device] > 1}{if $product_images_count == 1}--double{elseif $product_images_count < 1}--single{/if}{/if}">
            ...
            {hook name="products:view_main_info"}
                ...
                <div class="ut2-pb__right">
                    ...
                    <div class="ut2-pb__title">
                        {if $settings.abt__ut2.products.view.show_brand_format[$settings.abt__device] == "name" && $settings.abt__ut2.general.brand_feature_id}
