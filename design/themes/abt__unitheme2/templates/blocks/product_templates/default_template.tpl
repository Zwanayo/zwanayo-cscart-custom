...
<div class="ut2-pb ty-product-block ty-product-detail ty-product-detail {if $settings.abt__ut2.products[$settings.abt__details_layout].multiple_product_images[$settings.abt__device] > 1}{if $product_images_count == 1}--double{elseif $product_images_count < 1}--single{/if}{/if}">
