...
{assign var="product_details_mobile_thumbnail_width" value=400}
{assign var="product_details_mobile_thumbnail_height" value=400}
            ...
            <div class="ut2-pb__img-wrapper ty-product-block__img-wrapper">
                ...
                {if !$no_images}
                    <div class="ut2-pb__img {if $product_images_count < 1} ut2-pb__no-thumbs{/if} cm-reload-{$product.product_id} {if $settings.Appearance.thumbnails_gallery == "YesNo::YES"|enum}ut2-pb__as-gallery{else}ut2-pb__as-thumbs{/if}" data-ca-previewer="true" id="product_images_{$product.product_id}_update">
                        {include file="views/products/components/product_images.tpl" image_width=$product_details_mobile_thumbnail_width image_height=$product_details_mobile_thumbnail_height  product=$product show_detailed_link="YesNo::YES"|enum lazy_load=false thumbnails_size=35}
