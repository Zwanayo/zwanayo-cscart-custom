...
{if $settings.abt__device != "mobile"}
    ...
    *}
    ...
    <div class="ut2-pb ty-product-block ty-product-detail ut2-big-image ut2-big-image-gallery {if $product_images_count > 1}--three{elseif $product_images_count == 1}--double{else}--single{/if}">
        ...
        <div class="ut2-pb__wrapper clearfix">
            ...
            {if $product}
                ...
                <div class="ut2-pb__img-wrapper ty-product-block__img-wrapper">
                    ...
                    {if !$no_images}
                        <div class="ut2-pb__img {if $product_images_count < 1} ut2-pb__no-thumbs{/if} cm-reload-{$product.product_id} {if $settings.Appearance.thumbnails_gallery == "YesNo::YES"|enum}ut2-pb__as-gallery{else}ut2-pb__as-thumbs{/if}"
